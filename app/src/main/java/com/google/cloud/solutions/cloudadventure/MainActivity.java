...
public class MainActivity extends Activity {
  ...
  private void handleUserSelectionLogic() {
    ...
    private class ResistGMS extends AsyncTask<MainActivity, Void, Void> {
        @Override
        protected Void doInBackground(MainActivity... activities) {

            GCMIntentService.register(activities[0], mCurrentUserHandle);
            return null;
        }
    }
  ...
  private void setCurrentUserHandle(String handle) {
    ...
    writeHandleToSharedPrefs(mCurrentUserHandle);
      ...
      new ResistGMS().execute(MainActivity.this);
